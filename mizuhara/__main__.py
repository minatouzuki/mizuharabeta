...
from mizuhara.plugins import ALL_PLUGINS
...
from mizuhara.utils.redishelper import set_key, flushredis, allkeys
...
class Mizuhara(Client):
    """Starts the Pyrogram Client on the Bot Token when we do 'python3 -m mizuhara'"""
