...
from mizuhara.__main__ import Alita
from pyrogram import filters, errors
from pyrogram.types import Message
from mizuhara import PREFIX_HANDLER, LOGGER, SUPPORT_GROUP
from mizuhara.utils.localization import GetLang
from mizuhara.utils.admin_check import admin_check
from mizuhara.utils.extract_user import extract_user
from mizuhara.utils.parser import mention_html
from mizuhara.utils.redishelper import get_key, set_key
...
@Mizuhara.on_message(filters.command("adminlist", PREFIX_HANDLER) & filters.group)
...
@Mizuhara.on_message(filters.command("admincache", PREFIX_HANDLER) & filters.group)
...
@Mizuhara.on_message(filters.command("ban", PREFIX_HANDLER) & filters.group)
...
@Mizuhara.on_message(filters.command("unban", PREFIX_HANDLER) & filters.group)
async def unban_usr(c: Mizuhara, m: Message):
...
@Mizuhara.on_message(filters.command("promote", PREFIX_HANDLER) & filters.group)
async def promote_usr(c: Mizuhara, m: Message):
...
@Mizuhara.on_message(filters.command("demote", PREFIX_HANDLER) & filters.group)
...
@Mizuhara.on_message(filters.command("invitelink", PREFIX_HANDLER) & filters.group)
async def demote_usr(c: Mizuhara, m: Message):
...
@Mizuhara.on_message(filters.command("pin", PREFIX_HANDLER) & filters.group)
...
@Mizuhara.on_message(filters.command("unpin", PREFIX_HANDLER) & filters.me)
