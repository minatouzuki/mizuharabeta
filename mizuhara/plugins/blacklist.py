...
from mizuhara.db import blacklist_db as db, approve_db as app_db
from mizuhara.utils.regex_utils import regex_searcher
...
@Mizuhara.on_message(filters.command("blacklist", PREFIX_HANDLER) & filters.group)
...
@Mizuhara.on_message(filters.command("addblacklist", PREFIX_HANDLER) & filters.group)
...
@Mizuhara.on_message(filters.group, group=11)
