...
from mizuhara.db import approve_db as app_db
...
@Mizuhara.on_message(filters.command("locktypes", PREFIX_HANDLER) & filters.group)
async def lock_types(c: Mizuhara, m: Message):
    types = (
        "**Lock Types:**\n"
        " - `all` = Everything\n"
        " - `msg` = Messages\n"
...
@Mizuhara.on_message(filters.command("lock", PREFIX_HANDLER) & filters.group)
...
@Mizuhara.on_message(filters.command("locks", PREFIX_HANDLER) & filters.group)
...
@Mizuhara.on_message(filters.command("unlock", PREFIX_HANDLER) & filters.group)
