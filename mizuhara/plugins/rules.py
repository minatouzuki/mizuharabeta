...
from mizuhara.db import rules_db as db
...
@Mizuhara.on_message(filters.command("rules", PREFIX_HANDLER) & filters.group)
...
@Mizuhara.on_message(filters.command("setrules", PREFIX_HANDLER) & filters.group)
...
@Mizuhara.on_message(filters.command("clearrules", PREFIX_HANDLER) & filters.group)
...
@Mizuhara.on_callback_query(filters.regex("^clear.rules$"))
